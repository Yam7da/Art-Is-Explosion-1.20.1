...
package net.yam7da.artisexplosion.renderers;
...
public class ArtIsExplosionBlockEntityRenderer<T extends DynamiteEntity> extends EntityRenderer<T> {

    private final Function<T, BlockState> stateGetter;
    private final BlockRenderManager blockRenderManager;

    public ArtIsExplosionBlockEntityRenderer(EntityRendererFactory.Context ctx, Function<T, BlockState> stateGetter) {
        super(ctx);
